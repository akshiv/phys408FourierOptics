...
These pixel intensities were plotted and shown above. The blue curve shows the intensity of the pixels going vertically through the reference lines (dips) and then through 3 spots of the FT (peaks). The red curve is the pixel intensity vertically through the center of
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjg2NjkyOTcxXX0=
-->