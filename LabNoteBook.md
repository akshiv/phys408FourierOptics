...
If we were to phase shift the DC component by $90~^\circ$ (by a factor of $i$) we should be able to distinguish the differences in phase much easier. Here$f(x,y)$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3OTg4NjczNzJdfQ==
-->